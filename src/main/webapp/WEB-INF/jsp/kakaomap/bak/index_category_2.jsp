...
<div class="map_wrap">
    ...
    <ul id="category">
        <li id="01" keyword="선별진료소" data-order="0"> 
            <span class="category_bg bank"></span>선별<br/>진료소
        </li>       
        <li id="02" keyword="안심병원" data-order="1"> 
            <span class="category_bg mart"></span>안심병원
        </li>  
    </ul>
</div>
...
var placeOverlay = new kakao.maps.CustomOverlay({zIndex:1}), 
    ...
    currCd = ''; // 현재 선택된 카테고리를 가지고 있을 변수입니다
...
//     ps.categorySearch(currCategory, placesSearchCB, {useMapBounds:true}); 
    ps.keywordSearch(convertCurrCdToKeyword(currCd), placesSearchCB, {useMapBounds:true});
}
